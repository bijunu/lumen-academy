...
export const stateChanges: SkillNode = {
  ...
  questions: [
    ...
    },
    {
      ...
      hotspots: [
        { id: 'scc-q12-h1', x: 32.8, y: 47.5, correctLabel: 'Melting' },
        { id: 'scc-q12-h2', x: 32.8, y: 84, correctLabel: 'Freezing' },
        { id: 'scc-q12-h3', x: 67.2, y: 47.5, correctLabel: 'Boiling' },
        { id: 'scc-q12-h4', x: 67.2, y: 84, correctLabel: 'Condensing' },
      ],
