...
export const periodicTableZone: Zone = {
  ...
  realm: 'elementia',
  nodeIds: [
    'chemistry-periodic-table-layout',
    'chemistry-periodic-table-group-1-7',
    'chemistry-periodic-table-mendeleev',
    'chemistry-periodic-table-electron-shells',
    'chemistry-periodic-table-group-1-water',
    'chemistry-periodic-table-group-7-states',
    'chemistry-periodic-table-halogen-displacement',
    'chemistry-periodic-table-reactivity-series',
    'chemistry-periodic-table-group-0',
    'chemistry-periodic-table-period-trends',
    'chemistry-periodic-table-transition-metals',
    'chemistry-periodic-table-predict-properties',
    'chemistry-periodic-table-atomic-radius',
  ],
}
