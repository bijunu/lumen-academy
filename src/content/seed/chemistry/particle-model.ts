...
export const statesOfMatter: SkillNode = {
  ...
  questions: [
    ...
    },
    {
      ...
      hotspots: [
        { id: 'pms-q12-h1', x: 16.7, y: 50, correctLabel: 'Solid' },
        { id: 'pms-q12-h2', x: 50, y: 50, correctLabel: 'Liquid' },
        { id: 'pms-q12-h3', x: 83.3, y: 50, correctLabel: 'Gas' },
      ],
    ...
    },
    {
      ...
      hotspots: [
        { id: 'pms-q19-h1', x: 16.7, y: 70, correctLabel: 'Solid' },
        { id: 'pms-q19-h2', x: 50, y: 65, correctLabel: 'Liquid' },
        { id: 'pms-q19-h3', x: 93.3, y: 25, correctLabel: 'Gas' },
      ],
...
export const particleModelZone: Zone = {
  ...
  nodeIds: [
    ...
    'chemistry-particle-model-evaporation-boiling',
    'chemistry-particle-model-gas-pressure',
    'chemistry-particle-model-density-state',
    'chemistry-particle-model-compressibility',
    'chemistry-particle-model-temperature-energy',
    'chemistry-particle-model-diffusion-factors',
    'chemistry-particle-model-shape-volume',
    'chemistry-particle-model-brownian-motion',
    'chemistry-particle-model-latent-heat',
    'chemistry-particle-model-surface-tension',
  ],
}
