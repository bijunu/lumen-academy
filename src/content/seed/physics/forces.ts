...
export const forcesBalanced: SkillNode = {
  ...
  questions: [
    ...
    },
    {
      id: 'fb-q8',
      type: 'labelled-image',
      stem: 'An 80 N box rests still on a flat floor. Place the names on the two force arrows shown on the free-body diagram. Each label encodes the force\'s direction.',
      tier: 'core',
      viewBox: '0 0 800 400',
      svg: STATIONARY_FBD_SVG,
      hotspots: [
        { id: 'fb-q8-h1', x: 55, y: 87, correctLabel: 'Weight (down)' },
        { id: 'fb-q8-h2', x: 55, y: 35, correctLabel: 'Normal contact (up)' },
      ],
      labels: ['Weight (down)', 'Normal contact (up)', 'Friction (left)', 'Tension (up)'],
      xpValue: 15,
      hint: 'The arrow pulling down from the bottom of the box is the weight; the arrow pushing up from the floor is the normal contact force.',
    },
    {
      id: 'fb-q9',
      type: 'multiple-choice',
      stem: 'A car drives along a flat motorway at a steady 30 m/s (constant speed in a straight line). Which sentence is correct? Note that weight pulls the car down and the road pushes up with the same size of force, so the vertical pair already balances.',
      tier: 'confident',
      options: [
    ...
    },
    {
      id: 'fb-q19',
      type: 'multiple-choice',
      stem: 'A double-decker bus pulling out of a Manchester stop has a forwards engine force shown as a 1200 N arrow pointing right and a backwards drag arrow of 850 N pointing left. The vertical pair (weight and normal contact) is already balanced. What is the net horizontal force on the bus, and which way does it point?',
      tier: 'challenge',
      options: [
        '350 N to the right; the bus speeds up.',
        '2050 N to the right; the bus speeds up.',
        '350 N to the left; the bus slows down.',
        '0 N; the bus moves at a steady speed.',
      ],
      correctIndex: 0,
      xpValue: 20,
      misconceptionId: 'fb-mis-applied-equals-motion',
      hint: 'Subtract the smaller arrow from the larger; the net force points in the direction of the larger arrow.',
    },
    {
      id: 'fb-q20',
      type: 'multiple-choice',
